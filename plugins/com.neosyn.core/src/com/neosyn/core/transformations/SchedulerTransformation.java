...
/**
 * This class defines a transformation that transforms the scheduler of actions.
 * 

 * 
 */
public class SchedulerTransformation extends Transformation {

	public SchedulerTransformation(AbstractIrVisitor irVisitor) {
		super(irVisitor);
	}
