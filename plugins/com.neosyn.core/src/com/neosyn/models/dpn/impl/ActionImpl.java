...
import com.neosyn.models.dpn.Pattern;
 ...
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getBody <em>Body</em>}</li>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getCombinational <em>Combinational</em>}</li>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getInputPattern <em>Input Pattern</em>}</li>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getName <em>Name</em>}</li>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getOutputPattern <em>Output Pattern</em>}</li>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getPeekPattern <em>Peek Pattern</em>}</li>
 * <li>{@link com.neosyn.models.dpn.impl.ActionImpl#getScheduler <em>Scheduler</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends EObjectImpl implements Action {
	...
	/**
	 * The cached value of the '{@link #getCombinational() <em>Combinational</em>}' containment
	 ...
	 * @ordered
	 */
	protected Procedure combinational;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCombinational(Procedure newCombinational,
			NotificationChain msgs) {
		Procedure oldCombinational = combinational;
		combinational = newCombinational;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DpnPackage.ACTION__COMBINATIONAL, oldCombinational, newCombinational);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DpnPackage.ACTION__BODY:
			return getBody();
		case DpnPackage.ACTION__COMBINATIONAL:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
		...
		case DpnPackage.ACTION__COMBINATIONAL:
			return basicSetCombinational(null, msgs);
		case DpnPackage.ACTION__INPUT_PATTERN:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DpnPackage.ACTION__BODY:
			...
			return;
		case DpnPackage.ACTION__COMBINATIONAL:
			setCombinational((Procedure) newValue);
			return;
		case DpnPackage.ACTION__INPUT_PATTERN:
	...
	public void eUnset(int featureID) {
		...
		case DpnPackage.ACTION__BODY:
			...
			return;
		case DpnPackage.ACTION__COMBINATIONAL:
			setCombinational((Procedure) null);
			return;
		case DpnPackage.ACTION__INPUT_PATTERN:
	 ...
	 * @generated
	 */
	public Procedure getCombinational() {
		...
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject) body).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DpnPackage.ACTION__BODY, null, msgs);
			if (newBody != null)
	 ...
	 * @generated
	 */
	public void setCombinational(Procedure newCombinational) {
		if (newCombinational != combinational) {
			NotificationChain msgs = null;
			if (combinational != null)
				msgs = ((InternalEObject) combinational).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DpnPackage.ACTION__COMBINATIONAL, null, msgs);
			if (newCombinational != null)
				msgs = ((InternalEObject) newCombinational).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - DpnPackage.ACTION__COMBINATIONAL, null, msgs);
			msgs = basicSetCombinational(newCombinational, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DpnPackage.ACTION__COMBINATIONAL,
					newCombinational, newCombinational));
	}
		...
		if (newInputPattern != inputPattern) {
			...
			if (inputPattern != null)
				msgs = ((InternalEObject) inputPattern).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DpnPackage.ACTION__INPUT_PATTERN, null, msgs);
	...
	public void setOutputPattern(Pattern newOutputPattern) {
		if (newOutputPattern != outputPattern) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DpnPackage.ACTION__OUTPUT_PATTERN,
					newOutputPattern, newOutputPattern));
	}
		...
		if (newPeekPattern != peekPattern) {
			...
			if (peekPattern != null)
				msgs = ((InternalEObject) peekPattern).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DpnPackage.ACTION__PEEK_PATTERN, null, msgs);
		...
		if (newScheduler != scheduler) {
			...
			if (scheduler != null)
				msgs = ((InternalEObject) scheduler).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DpnPackage.ACTION__SCHEDULER, null, msgs);
