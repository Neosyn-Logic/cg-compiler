...
package com.neosyn.models.graph.impl;
 ...
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.graph.impl.EdgeImpl#getLabel <em>Label</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.EdgeImpl#getSource <em>Source</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.EdgeImpl#getTarget <em>Target</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.EdgeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EdgeImpl extends EObjectImpl implements Edge {
	...
	public NotificationChain basicSetSource(Vertex newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphPackage.EDGE__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetTarget(Vertex newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GraphPackage.EDGE__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setLabel(String newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.EDGE__LABEL,
					oldLabel, label));
	}
	...
	public void setSource(Vertex newSource) {
		if (newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.EDGE__SOURCE,
					newSource, newSource));
	}
	...
	public void setTarget(Vertex newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.EDGE__TARGET,
					newTarget, newTarget));
	}
	...
	public EObject getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GraphPackage.EDGE__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(EObject newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.EDGE__VALUE,
					oldValue, value));
	}
