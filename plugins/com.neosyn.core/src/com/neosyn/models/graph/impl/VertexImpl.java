 ...
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.graph.impl.VertexImpl#getNumber <em>Number</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.VertexImpl#getIncoming <em>Incoming</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.VertexImpl#getOutgoing <em>Outgoing</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.VertexImpl#getPredecessors <em>Predecessors</em>}</li>
 * <li>{@link com.neosyn.models.graph.impl.VertexImpl#getSuccessors <em>Successors</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public EList<Vertex> getSuccessors() {
		if (successors == null) {
			...
			for (Edge edge : getOutgoing()) {
				...
				// Skip null targets to avoid EMF "no null" constraint violation
