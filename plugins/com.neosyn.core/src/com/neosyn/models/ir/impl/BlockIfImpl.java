...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>BlockIf</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.BlockIfImpl#getCondition <em>Condition</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockIfImpl#getElseBlocks <em>Else Blocks</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockIfImpl#getJoinBlock <em>Join Block</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockIfImpl#getLineNumber <em>Line Number</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockIfImpl#getThenBlocks <em>Then Blocks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockIfImpl extends BlockImpl implements BlockIf {
	...
	/**
	 * The cached value of the '{@link #getElseBlocks() <em>Else Blocks</em>}' containment reference
	...
	/**
	 * The cached value of the '{@link #getThenBlocks() <em>Then Blocks</em>}' containment reference
	 * list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getThenBlocks()
	 * @generated
	...
	public void setCondition(Expression newCondition) {
		if (newCondition != condition) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.BLOCK_IF__CONDITION,
	...
	public void setJoinBlock(BlockBasic newJoinBlock) {
		if (newJoinBlock != joinBlock) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.BLOCK_IF__JOIN_BLOCK,
					newJoinBlock, newJoinBlock));
	}
	...
	public void setLineNumber(int newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.BLOCK_IF__LINE_NUMBER,
