...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>BlockWhile</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.BlockWhileImpl#getCondition <em>Condition</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockWhileImpl#getJoinBlock <em>Join Block</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockWhileImpl#getLineNumber <em>Line Number</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.BlockWhileImpl#getBlocks <em>Blocks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockWhileImpl extends BlockImpl implements BlockWhile {
	...
	public void setCondition(Expression newCondition) {
		if (newCondition != condition) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.BLOCK_WHILE__CONDITION,
	...
	public void setJoinBlock(BlockBasic newJoinBlock) {
		if (newJoinBlock != joinBlock) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.BLOCK_WHILE__JOIN_BLOCK,
	...
	public void setLineNumber(int newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IrPackage.BLOCK_WHILE__LINE_NUMBER, oldLineNumber, lineNumber));
	}
