...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Expr Var</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.ExprVarImpl#getUse <em>Use</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetUse(Use newUse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.EXPR_VAR__USE, oldUse, newUse);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newUse != use) {
			...
			if (use != null)
				msgs = ((InternalEObject) use).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - IrPackage.EXPR_VAR__USE, null, msgs);
			if (newUse != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.EXPR_VAR__USE, newUse,
					newUse));
	}
