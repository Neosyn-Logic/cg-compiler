...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Inst Assign</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.InstAssignImpl#getTarget <em>Target</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.InstAssignImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstAssignImpl extends InstructionImpl implements InstAssign {
	...
	public NotificationChain basicSetValue(Expression newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.INST_ASSIGN__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTarget(Def newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.INST_ASSIGN__TARGET,
					newTarget, newTarget));
	}
	...
	public void setValue(Expression newValue) {
		if (newValue != value) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.INST_ASSIGN__VALUE,
					newValue, newValue));
	}
	...
	public String toString() {
		return super.toString() + "Assign(" + getNameSSA(target.getVariable()) + ", "
				+ new ExpressionPrinter().toString(getValue()) + ")";
	}
} // InstAssignImpl
