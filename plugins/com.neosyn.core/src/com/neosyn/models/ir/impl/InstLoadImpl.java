...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Inst Load</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.InstLoadImpl#getIndexes <em>Indexes</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.InstLoadImpl#getSource <em>Source</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.InstLoadImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstLoadImpl extends InstructionImpl implements InstLoad {
	...
	public NotificationChain basicSetSource(Use newSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.INST_LOAD__SOURCE, oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetTarget(Def newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.INST_LOAD__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - IrPackage.INST_LOAD__SOURCE, null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.INST_LOAD__SOURCE,
					newSource, newSource));
	}
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - IrPackage.INST_LOAD__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.INST_LOAD__TARGET,
					newTarget, newTarget));
	}
	...
	public String toString() {
		...
		builder.append("Load(").append(getNameSSA(getTarget().getVariable())).append(", ")
