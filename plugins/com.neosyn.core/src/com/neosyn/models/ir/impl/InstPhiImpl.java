...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Inst Phi</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.InstPhiImpl#getOldVariable <em>Old Variable</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.InstPhiImpl#getTarget <em>Target</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.InstPhiImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstPhiImpl extends InstructionImpl implements InstPhi {
	...
	public NotificationChain basicSetTarget(Def newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.INST_PHI__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
			...
			if (oldVariable != oldOldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							IrPackage.INST_PHI__OLD_VARIABLE, oldOldVariable, oldVariable));
			}
		}
		return oldVariable;
	}
	...
	public void setOldVariable(Var newOldVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.INST_PHI__OLD_VARIABLE,
	...
	public void setTarget(Def newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.INST_PHI__TARGET,
					newTarget, newTarget));
	}
	...
	public String toString() {
		...
		for (Expression value : getValues()) {
			builder.append(", ");
			builder.append(new ExpressionPrinter().toString(value));
		}
