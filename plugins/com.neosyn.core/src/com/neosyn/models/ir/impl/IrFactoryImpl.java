...
import static com.neosyn.models.ir.ExprTypeConv.SIGNED;
import static com.neosyn.models.ir.ExprTypeConv.UNSIGNED;
import static com.neosyn.models.ir.OpBinary.LOGIC_AND;
import static com.neosyn.models.ir.OpBinary.LOGIC_OR;
import static com.neosyn.models.ir.OpUnary.LOGIC_NOT;
import static com.neosyn.models.util.EcoreHelper.copyIfNeeded;
...
public class IrFactoryImpl extends EFactoryImpl implements IrFactory {
	...
	public Expression cast(Type target, Type source, Expression expr, boolean forceResize) {
		// Handle null types (unresolved proxies to built-in entity ports)
