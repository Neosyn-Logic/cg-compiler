...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Use</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.UseImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UseImpl extends EObjectImpl implements Use {
	...
	public NotificationChain basicSetVariable(Var newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.USE__VARIABLE, oldVariable, newVariable);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		case IrPackage.USE__VARIABLE:
			if (variable != null)
				msgs = ((InternalEObject) variable).eInverseRemove(this, IrPackage.VAR__USES,
						Var.class, msgs);
		...
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject) variable).eInverseRemove(this, IrPackage.VAR__USES,
						Var.class, msgs);
			if (newVariable != null)
				msgs = ((InternalEObject) newVariable).eInverseAdd(this, IrPackage.VAR__USES,
						Var.class, msgs);
			msgs = basicSetVariable(newVariable, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.USE__VARIABLE,
