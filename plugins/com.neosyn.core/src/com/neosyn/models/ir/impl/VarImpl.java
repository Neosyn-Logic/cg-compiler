 ...
 * </p>
 * <ul>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#isAssignable <em>Assignable</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getDefs <em>Defs</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#isGlobal <em>Global</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getIndex <em>Index</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getInitialValue <em>Initial Value</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getLineNumber <em>Line Number</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#isLocal <em>Local</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getName <em>Name</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getType <em>Type</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getUses <em>Uses</em>}</li>
 * <li>{@link com.neosyn.models.ir.impl.VarImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarImpl extends EObjectImpl implements Var {
	...
	/**
	 * The default value of the '{@link #isGlobal() <em>Global</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #isGlobal()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getInitialValue() <em>Initial Value</em>}' containment
	...
	public NotificationChain basicSetInitialValue(Expression newInitialValue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.VAR__INITIAL_VALUE, oldInitialValue, newInitialValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					IrPackage.VAR__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public boolean isGlobal() {
		...
		return (cter instanceof Actor || cter instanceof DPN || cter instanceof Unit);
	}

	@Override
	public boolean isLocal() {
		return eContainer() instanceof Procedure;
	}
	...
	public void setAssignable(boolean newAssignable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__ASSIGNABLE,
					oldAssignable, assignable));
	}
	...
	public void setIndex(int newIndex) {
		...
		index = newIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__INDEX, oldIndex,
					index));
	}
	...
	public void setInitialValue(Expression newInitialValue) {
		if (newInitialValue != initialValue) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__INITIAL_VALUE,
	...
	public void setLineNumber(int newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__LINE_NUMBER,
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__NAME, oldName,
					name));
	}
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - IrPackage.VAR__TYPE, null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__TYPE, newType,
					newType));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IrPackage.VAR__VALUE, oldValue,
					value));
	}
